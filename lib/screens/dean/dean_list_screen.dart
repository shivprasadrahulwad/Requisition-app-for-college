...
class DeanListScreen extends StatefulWidget {
  const DeanListScreen({Key? key}) : super(key: key);

  @override
  State<DeanListScreen> createState() => _DeanListScreenState();
}

class _DeanListScreenState extends State<DeanListScreen> {
